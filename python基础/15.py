...
information = {'Name':'James', 'QQ':145454532, 'Age':27}  #用 ： 分割
print('%s  %d  %d'%(information['Name'],information['Age'],information['QQ']))
print(information)
...
#修改
infor['Age'] = 47  #字典里会把key相同的元素值直接覆盖
print(infor)

dic =[]
dic.append(information)
dic.append(infor)
print(dic)
